...
|----------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`step_lencode_glm()`](https://rmsharp.github.io/embedmit/reference/step_lencode_glm.md)     | GLM-based effect encoding (no pooling)              |
| [`step_lencode_mixed()`](https://rmsharp.github.io/embedmit/reference/step_lencode_mixed.md) | Mixed effects encoding (partial pooling)            |
| [`step_lencode_bayes()`](https://rmsharp.github.io/embedmit/reference/step_lencode_bayes.md) | Bayesian encoding (full uncertainty quantification) |
| [`step_woe()`](https://rmsharp.github.io/embedmit/reference/step_woe.md)                     | Weight of evidence transformation (binary outcomes) |
| [`step_umap()`](https://rmsharp.github.io/embedmit/reference/step_umap.md)                   | UMAP embeddings via uwotmit                         |
