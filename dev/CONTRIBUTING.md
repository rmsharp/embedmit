...
This outlines how to propose a change to embed. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("topepo/embed", fork = TRUE)`.
...
Please note that the embed project is released with a [Contributor Code
of Conduct](https://rmsharp.github.io/embedmit/dev/CODE_OF_CONDUCT.md).
