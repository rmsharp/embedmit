...
required_pkgs <- c("modeldata", "ggplot2", "lme4", "dplyr", "rsample", "purrr")
...
#| fig-cap: "Comparison of GLM (no pooling) versus mixed effects (partial pooling) encodings. Point size represents the number of observations in each neighborhood. Points below the diagonal indicate shrinkage toward the mean."
glm_estimates %>%
