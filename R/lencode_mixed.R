...
#'   `step_lencode_mixed`, this indicates the variables to be encoded into a
...
#' as well as any arguments given to the `options` argument to the step.
#' Relevant options include `control` and others.
#'
#' # Tidying
#'
