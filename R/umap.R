...
#'   neighbors. See [uwotmit::umap()] for more details. Default `"euclidean"`.
#' @param epochs Number of iterations for the neighbor optimization. See
#'   [uwotmit::umap()] for more details.
...
#'   coordinates. See [uwotmit::umap()] for details. Default `"spectral"`.
...
#' @param options A list of options to pass to [uwotmit::umap()]. The arguments
