...
| uwotlite | 85.33%   | bigstatsr_init (0%), umap2 (76%) |

**Fork improvements:** uwotlite's umap2.R coverage increased from 0% to 76%
...
|------|-------------|-------------|
| R/umap.R | **Substantive** | Added `rng_type = "tausworthe"` default, uwotlite namespace |
| R/umap.R | Bugfix | Moved NULL checks before validation for backwards compat |
| R/*.R (16 files) | Documentation | Updated uwot → uwotlite references |

---

## Code Changes Analysis

### uwotlite: Files Modified
...
**Total Requests:** 24 distinct tasks
